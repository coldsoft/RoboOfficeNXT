	...
	implements TableCellRenderer, TableCellEditor, ActionListener, MouseListener
{
	 ...
	 */
	public ButtonColumn(JTable table, Action action, int column, boolean deleteButton)
	{
      ...
      renderButton.setFont(FontsLoader.getButtonFont());
      

		editButton = new JButton();
      editButton.setFont(FontsLoader.getButtonFont());
