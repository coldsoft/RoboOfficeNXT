 ...
 * @author Coldsoft
 */
public class ProgressReportSectionSettingPanel extends javax.swing.JPanel {

   /**
    * Creates new form ProgressReportSectionSettingPanel
    */
   ...
   public ProgressReportSectionSettingPanel(ProgressReportTypeTab parent) {
      initComponents();
      this.parent = parent;
   }
