 ...
 */
package ca.robokids.robooffice.desktop.tabs.school.components;
 ...
 * @author Coldsoft
 */
public class ClassroomSettingPanel extends javax.swing.JPanel {

   /**
    * Creates new form ClassroomSettingPanel
    */
   DefaultListModel<Activity> activityModel = new DefaultListModel();
   Classroom classroom;
   Tab parent;

   public ClassroomSettingPanel(Tab parent) {
      initComponents();
      this.parent = parent;
