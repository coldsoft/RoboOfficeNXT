...
public class AttendancePanel extends javax.swing.JPanel {
   ...
   @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        classroomContainer.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        classroomContainer.setMinimumSize(new java.awt.Dimension(900, 420));
        classroomContainer.setPreferredSize(new java.awt.Dimension(900, 420));
